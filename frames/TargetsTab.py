...
class TargetFrame(Frame.Frame):
    def __init__(self, row, column, **kwargs):
        ...
        self.addChildWidgets((
            Textboxes.PlusMinusTextboxFrame("Freq", 0, 0, increase, decrease, command=validate_freq, default_value=10.0),
            ...
            Textboxes.ColorTextboxFrame("Color1", 1, 4, default_value="#ffffff"),
            ...
            Textboxes.ColorTextboxFrame("Color2", 2, 4, default_value="#000000"),
        ))