...
class PsdaOptionsFrame(OptionsFrame):
    def __init__(self, parent, row, column, **kwargs):
        ...
        self.addChildWidgets((
            ...
            OptionMenu.OptionMenu  (self.widget, c.OPTIONS_DETREND,   2, 1, c.DETREND_NAMES),
            OptionMenu.OptionMenu  (self.widget, c.OPTIONS_WINDOW,    2, 4, c.WINDOW_FUNCTION_NAMES, command=self.enableWindow),
            OptionMenu.OptionMenu  (self.widget, c.OPTIONS_INTERPOLATE, 3, 1, c.INTERPOLATE_NAMES),
            OptionMenu.OptionMenu  (self.widget, c.OPTIONS_FILTER,    3, 4, c.FILTER_NAMES, command=self.enableFilter),
