...
class AbstractMasterConnection(Connections.MultipleConnections):
    def __init__(self, connections, connection_to_data):
        Connections.MultipleConnections.__init__(self)
        self.connections = connections
        self.connection_to_data = connection_to_data
...
class MasterConnection(AbstractMasterConnection):
    def __init__(self):
...
class TrainingMasterConnection(AbstractMasterConnection):
    def __init__(self):
        AbstractMasterConnection.__init__(
            self,
            {
