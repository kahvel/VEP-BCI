...
TRAIN_START_MESSAGE = "TrainStart"
TRAIN_STOP_MESSAGE = "TrainStop"
TRAIN_SETUP_MESSAGE = "TrainSetup"
TRAIN_SUCCESS_MESSAGE = "TrainSuccess"
TRAIN_FAIL_MESSAGE = "TrainFail"
...
TRAINING_MESSAGES = {
    START_MESSAGE: TRAIN_START_MESSAGE,
    STOP_MESSAGE: TRAIN_STOP_MESSAGE,
    SETUP_MESSAGE: TRAIN_SETUP_MESSAGE,
    FAIL_MESSAGE: TRAIN_FAIL_MESSAGE,
    SUCCESS_MESSAGE: TRAIN_SUCCESS_MESSAGE,
    EXIT_MESSAGE: EXIT_MESSAGE,
}
