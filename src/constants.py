...
MAIN_WINDOW_MESSAGES = (BCI_STOPPED_MESSAGE, SETUP_SUCCEEDED_MESSAGE, SETUP_FAILED_MESSAGE)
...
TRAINING_MESSAGES = (SEND_RECORDED_FEATURES_MESSAGE, SEND_CLASSIFICATION_OPTIONS, TRAINING_START_MESSAGE)
